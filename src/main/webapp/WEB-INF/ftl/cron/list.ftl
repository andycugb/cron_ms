            ...
            <div id="dataTableWrap">
                <div id="virtualHeadTableBox">
                    <form name='${divid}listform' action='${ctx}/cron/list.do' method="post">
                        ...
                        <table class="table_line">
                            <tr>
                                <th class="tc" colspan="4"><b>Cron查询</b></th>
                            </tr>
                            <tr>
                                <th width="100px" style="text-align:left;">CronName:</th>
                                <td style="text-align:left;">
                                    <input type="text" id="cronName" name="cronName"
                                           value="${cronQueryCond.cronName?if_exists}" maxlength="100" size="25"/>
                                </td>
                                <th width="100px" style="text-align:left;">Cron描述：</th>
                                <td style="text-align:left;">
                                    <input type="text" id="cronDesc" name="cronDesc"
                                           value="${cronQueryCond.cronDesc?if_exists}" maxlength="100" size="25"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:left;"><select name="fireOnStartUp" id="fireOnStartUp">
                                    ...
                                    <option value="0"<#if cronQueryCond.fireOnStartUp?exists&&cronQueryCond.fireOnStartUp==0>
                                            selected</#if>>
                                        不执行
                                    </option>
                                    <option value="1"<#if cronQueryCond.fireOnStartUp?exists&&cronQueryCond.fireOnStartUp==1>
                                            selected</#if>>
                                        执行
                                    </option>
                                </select></td>
                                ...
                                <td style="text-align:left;">
                                    ...
                                    <#if cronGroupNames?exists&&cronGroupNames!="">
                                        <#list cronGroupNames?split(";") as cronGroupName>
                                            <option value="${cronGroupName?if_exists}"<#if cronQueryCond.groupName?exists&&cronQueryCond.groupName==cronGroupName>
                                                    selected</#if>>
                ...
                <div id="dataTableBox">
                    ...
                    ${opResult?no_encode}
                            ...
                            <#list cronList as cron>
                                <tr>
                                    ...
                                    <td style="white-space:normal;word-break:break-all"
                                        align="middle">${cron.groupName!}</td>
                                    <td>
                                            ...
                                            <#if  cron.execMachines?exists&&cron.execMachines!="">
                                                <select name="${cron.id}CronExecuteIp" id="${cron.id}CronExecuteIp">
                                                    <#list cron.execMachines?split(";") as cronIp>
                                                        ...
                                                        <#else>
                                                            <option value="${cronIp?if_exists}" <#if cronIp?exists&&cron.limitIp?exists&&(cron.limitIp!'*')==(cronIp!'')?split(":")[0]>
                                                                    selected</#if>>
                                                            ${cronIp?if_exists}
                                                            </option>
                                                        </#if>
                                                ...
                                                <a href="#" target="_blank"
                                                   onclick="doRefresh('${cron.id}','${cron.cronName}','${cron.groupName!}'+'_machines','');return false;">立即执行</a>
                                            </#if>
                                            <#if cron.execMachinesConfirm?exists&&cron.execMachinesConfirm!="">
                                                <br>
                                                <select name="${cron.id}CronExecuteIpOnlineConfirm"
                                                        id="${cron.id}CronExecuteIpOnlineConfirm">
                                                ...
                                                <a href="#" target="_blank"
                                                   onclick="doRefresh('${cron.id}','${cron.cronName}','${cron.groupName!}'+'_confirm_machines','OnlineConfirm');return false;">立即执行</a>
                                            </#if>
                        ...
                        <#else>
                            <tr>
                                <td colspan='9' align='middle'><span style='color:red;'>没有符合条件的Cron！</span></td>
                            </tr>
                        </#if>
                        </table>
                    </div>
