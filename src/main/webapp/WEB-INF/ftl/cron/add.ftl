...
<form action='${ctx}/cron/saveAdd.do' method="post" onsubmit="return checkForm();">
    ...
    <table class="table_line">
        ...
        <tr>
            <th>cron名称</th>
            <td><input type="text" name="cronName" id="cronName" size="80" value="${cron.cronName?if_exists}"><span
                    style='color:red;'>*</span></td>
        </tr>
        <tr>
            <th>执行方法</th>
            <td><input type="text" name="serviceName" id="serviceName" size="80"
                       value="${cron.serviceName?if_exists}"><span style='color:red;'>*</span></td>
        </tr>
        <tr>
            <th>执行策略</th>
